...
"""
创建一个用于测试IADS Ultimate框架的Mininet拓扑
拓扑结构：
    h1 --- s1 --- s2 --- h2
            |      |
            +--s3--+
...
class IADSTestTopology:
    ...
    def _scenario_varying_traffic(self):
        ...
        for src_name, dst_name, bw, duration in patterns:
            ...
            src.cmd('iperf -c {} -p 5001 -t {} -b {} &'.format(dst_ip, duration, bw))
