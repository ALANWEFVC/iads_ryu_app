...
class IADSApp(simple_switch_13.SimpleSwitch13):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.logger.info("IADS Step2O: Baseline + is_active")
    ...
    def switch_features_handler(self, ev):
        ...
        self.is_active = True  # 设置状态
        self.logger.info("IADS: Switch {} connected, is_active={}".format(datapath.id, self.is_active))
    ...
    def _packet_in_handler(self, ev):
        ...
        if self.packet_count % 20 == 0:
            self.logger.info("IADS: Processed {} packets, active={}".format(self.packet_count, self.is_active))
